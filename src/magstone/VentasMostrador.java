...
public class VentasMostrador extends javax.swing.JDialog {
  ...
  tableVentas.getTableHeader().setBackground(Color.white);
        ...
        tableVentas.getColumnModel().getColumn(6).setCellRenderer(new CurrencyCellRenderer());
         tableVentas.getColumnModel().getColumn(4).setCellRenderer(new CurrencyCellRenderer());  tableVentas.getColumnModel().getColumn(1).setCellRenderer(new TimestampCellRenderer());
  ...
  tableVentas.getColumnModel().getColumn(3).setCellRenderer(tcr);
        ...
        imagen1 = new ImageIcon(getClass().getResource("Images/VerPagos.png"));
        fondo1 = new ImageIcon(imagen1.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH));
        btnRegPagos.setIcon(fondo1);
...
jLabel5.setText("Ventas de "+Save.Clienttext);
    model=(DefaultTableModel)tableVentas.getModel(); 
        ...
        for(Sale obj: Sales)
        {
            model.addRow(new Object[]{obj.Id,obj.Date,obj.Description,obj.Comentario,obj.Monto,obj.MontoCobrado,obj.Saldo(),obj.Status()});
        }
...
Client client;
    ...
    private void initComponents() {
        ...
        cbxFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id venta", "Fecha", "Venta", "Comentario", "Monto total", "Monto cobrado", "Saldo", "Entregado" }));
        ...
        tableVentas.setBackground(new java.awt.Color(245, 245, 245));
        ...
        tableVentas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id venta", "Fecha", "Venta", "Comentario", "Monto total", "Monto cobrado", "Saldo", "Entregado"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Boolean.class
            };
...
MenuVentas.show(tableVentas, evt.getX(), evt.getY());
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
         ...
         a.ReporteSubVentas(Sales,Save.Clienttext); 
