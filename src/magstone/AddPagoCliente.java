...
double MontoEgr;
    ...
    private void initComponents() {
        ...
        txtDescripcionEgresos.setBackground(new java.awt.Color(245, 245, 245));
        ...
        txtFacturaEgresos.setBackground(new java.awt.Color(245, 245, 245));
        ...
        txtMontoEgresos.setBackground(new java.awt.Color(245, 245, 245));
        ...
        jLabel11.setText("Agregar pago de venta");
    ...
    private void btnCapturaEgresosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapturaEgresosActionPerformed
        try{
            ...
            con=new Conexion();
            con.Conectar();
            con.AddIncome(new Income(dtEgresos.getDate(),Save.Sale,1,txtDescripcionEgresos.getText(),cuenta.Id,fac,txtFacturaEgresos.getText(),MontoEgr));
            con.Desconectar();
